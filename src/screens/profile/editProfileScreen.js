...
export default class EditProfileScreen extends Component {
	...
	_bootstrapAsync = async () => {
		AsyncStorage.multiGet(['rememberToken', 'email', 'mobile_number','dob','first_name','last_name','avatar_location']).then(
		  response => {
			this.setState({
			  ...
			  />
				...
				>
				  ...
				  >
					...
					<View style={styles.frmInputWrapper}>
					  <Text style={styles.frmLabel}>Password</Text>
					  <TextInput
						style={errorPassword}
					...
					<View style={styles.frmInputWrapper}>
					  <Text style={styles.frmLabel}>Confirm password</Text>
					  <TextInput
					  style={errorPassword}
					...
					>
					  <Text style={styles.sendButtonText}>Update Now</Text>
