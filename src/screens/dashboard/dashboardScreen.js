  ...
  render() {
              ...
              <View style={{ flex: 1,}}>
                ...
                >
                  ...
                  <View style={styles.featureBlockWrapper}>
                    <TouchableOpacity
                      style={[tabIndex == 0 ? styles.block2Active:styles.block2InActive]}
                      onPress={() => this.getList(false,true,false,false,'0')}
                    >
                      <Text style={[tabIndex == 0 ? styles.block2ActiveText:styles.block2InActiveText]}>Wating</Text>
                    </TouchableOpacity>
  
                    <TouchableOpacity
                      style={[tabIndex == 1 ? styles.block1Active:styles.block1InActive]}
                      onPress={() => this.getList(true,false,false,false,'1')}
                    >
                      <Text style={[tabIndex == 1 ? styles.block1ActiveText:styles.block1InActiveText]}>Ongoing</Text>
                    </TouchableOpacity>
  
                    <TouchableOpacity
                      style={[tabIndex == 2 ? styles.block3Active:styles.block3InActive]}
                      onPress={() => this.getList(false,false,true,false,'2')}
                    >
                      <Text style={[tabIndex == 2 ? styles.block3ActiveText:styles.block3InActiveText]}>Blocked</Text>
                    </TouchableOpacity>
  
                    <TouchableOpacity
                      style={[tabIndex == 3 ? styles.block4Active:styles.block4InActive]}
                      onPress={() => this.getList(false,false,false,true,'3')}
                    >
                      <Text style={[tabIndex == 3 ? styles.block4ActiveText:styles.block4InActiveText]}>Suspended</Text>
                    </TouchableOpacity>
                  </View>
                    {
                      ...
                      <View>
                        {
                          ...
                          this.suspendListComponent(this.state.getList):null
                        }
                      </View>
                    }
                </View>
    ...
    waitinglistComponent = (response)=>{
      return(
        ...
        renderItem={({ item,index }) => (
          <TouchableOpacity activeOpacity={1} onPress={()=>this.props.navigation.navigate('rejectJoinPage',{result:item})}>
            <View style={[styles.listItemWrapper]}>
              <View style={styles.listLeftWrapper}>
                ...
                >
                  ...
                  <Text numberOfLines={1} style={[styles.listRightText,{paddingRight:20}]}>{this.getNames(item.get_users)}</Text>
                ...
                >
                  ...
                  <Text style={styles.listRightText}>€{item.target_achive}</Text>
                </View>
                ...
                >
                  ...
                  <Text style={styles.listRightText}>{CommonService.formatDate(item.end_date)}</Text>
                </View>
              </View>
    ...
    onGoingListComponent = (response)=>{
      return(
        ...
        data={response}
        renderItem={({ item,index }) => (
          <TouchableOpacity activeOpacity={1} onPress={()=>this.props.navigation.navigate('ongingPage',{result:item})}>
            <View style={styles.listItemWrapper}>
              <View style={styles.listLeftWrapper}>
                <View
                  style={{ flexDirection: 'row', alignItems: 'center' }}
                ...
                >
                  ...
                  <Text numberOfLines={1} style={[styles.listRightText,{width:wp('33%')}]}>{this.getNames(item.get_users)}</Text>
                </View>
                ...
                >
                  ...
                  <Text style={styles.listRightText}>{item.expected_payable_date}</Text>
                </View>
                ...
                >
                  ...
                  <Text style={styles.listRightText}>{item.expected_next_payment_date}</Text>
                </View>
              ...
              >
                <ProgressCircle
                  percent={CommonService.getPercentage(item.completed_round,item.estimate_round)}
                  radius={hp('5%')}
                  borderWidth={8}
                  color="#3bdfde"
                  shadowColor="#ececec"
                  bgColor="#fff"
                >
                  <Text style={{ fontSize: 18 }}>{CommonService.getPercentage(item.completed_round,item.estimate_round)+'%'}</Text>
                </ProgressCircle>
              </View>
            </View>
          </TouchableOpacity>
    ...
    suspendListComponent = (response)=>{
      return(
        ...
        data={response}
        renderItem={({ item,index }) => (
          <TouchableOpacity activeOpacity={1} onPress={()=>this.props.navigation.navigate('suspendedScreen',{result:item})}>
          <View style={styles.listItemWrapper}>
            <View style={styles.listLeftWrapper}>
              <View
                style={{ flexDirection: 'row', alignItems: 'center' }}
              ...
              >
                ...
                </Text>
                {
                  item.completed_round > 1 ?
                  <Text style={styles.listRightText}>{item.completed_round+' rounds over out of '+item.estimate_round}</Text>:
                  <Text style={styles.listRightText}>{item.completed_round+' round over out of '+item.estimate_round}</Text>
                }
              </View>
            </View>
